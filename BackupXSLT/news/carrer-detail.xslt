        ...
        <section class="career-detail-section">
				<div class="container">
					<div class="row career-detail">
						<div class="col-lg-8">
							<div class="content">
								<h2 class="title-h1-grey"><xsl:value-of disable-output-escaping="yes" select="/NewsDetail/ZoneTitle"></xsl:value-of></h2>
								<p class="mota"><xsl:value-of disable-output-escaping="yes" select="/NewsDetail/Title"></xsl:value-of></p>
								<div class="full-content">
                                    ...
                                    <xsl:text disable-output-escaping="yes">Apply for job</xsl:text>
                                </a>
