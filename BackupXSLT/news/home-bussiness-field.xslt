...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
		...
		<section class="business">
			<div class="container">
				<h1 class="title-h1-grey" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
					<xsl:value-of disable-output-escaping="yes" select="/NewsList/ModuleTitle"></xsl:value-of>
				</h1>
				<div class="business-wrapper">
					<div class="business-slider" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
