...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="Zone">
		<div class="tab-content">
			...
			<div class="view-more-brand"><a><span><xsl:value-of disable-output-escaping="yes" select="/ZoneList/VMText"></xsl:value-of></span><em class="mdi mdi-chevron-down"></em></a></div>
		</div>
